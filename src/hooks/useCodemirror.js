...
import { insertTab, indentLess, defaultKeymap, history, historyKeymap } from '@codemirror/commands'
...
const extensions = [
    ...
    keymap.of([...defaultKeymap, ...historyKeymap, { key: 'Tab', run: insertTab }, { key: 'Shift-Tab', run: indentLess }]),
    indentUnit.of('\t'), 
